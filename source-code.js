...
<head>
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-4QPXKLD48W"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());
        gtag('config', 'G-4QPXKLD48W', {page_title: document.title, page_location: window.location.href});
    </script>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Noahs Tutoring | Math</title>
    <link rel="icon" type="image/x-icon" href="https://raw.githubusercontent.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/cuh.png" id="siteFavicon">
    <link rel="shortcut icon" href="https://raw.githubusercontent.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/cuh.png">
    <link rel="apple-touch-icon" href="https://raw.githubusercontent.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/cuh.png">
    <meta name="theme-color" content="#c27c15">
    <meta property="og:site_name" content="Noah's Tutoring Hub">
    <meta property="og:title" content="Noah's Tutoring Hub | 400+ Unblocked Games & Lessons">
    <meta property="og:description" content="Access hundreds of unblocked games, educational tools, and math lessons. The ultimate hub for students!">
    <meta property="og:url" content="https://noahs-calculus-tutor.pages.dev/">
    <meta property="og:type" content="website">
    <meta property="og:image" content="https://raw.githubusercontent.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/refs/heads/master/images/OG%20noahstutoring.png">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <meta property="og:image:alt" content="Noah's Tutoring Hub - Unblocked Games & Educational Resources">
    <meta property="og:locale" content="en_US">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Noah's Tutoring Hub | 400+ Unblocked Games">
    <meta name="twitter:description" content="The best collection of unblocked games and educational resources for students.">
    <meta name="twitter:image" content="https://raw.githubusercontent.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/refs/heads/master/images/OG%20noahstutoring.png">
    <meta name="twitter:image:alt" content="Noah's Tutoring Hub Banner">
    <meta name="description" content="Noah's Tutoring Hub - Access hundreds of unblocked games, math lessons, and educational resources. Perfect for students looking for fun learning tools.">
    <meta name="keywords" content="unblocked games, tutoring, math help, educational games, student resources, online learning">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        *{margin:0;padding:0;box-sizing:border-box;font-family:'Courier New',monospace}
        :root{
            --primary-orange:#c27c15;--primary-orange-rgb:194,124,21;--dark-bg:#0a0a0a;
            --light-text:#f0f0f0;--gray-text:#888;--accent-orange:#e69500;
            --cursor-bg:rgba(194,124,21,0.15);--cursor-border:rgba(194,124,21,0.5);
            --cursor-hover-bg:rgba(194,124,21,0.25);--cursor-hover-border:rgba(230,149,0,0.8)
        }
        body{background-color:var(--dark-bg);color:var(--light-text);overflow-x:hidden;line-height:1.6;cursor:none!important}
        #matrix-bg{position:fixed;top:0;left:0;width:100%;height:100%;z-index:-1;opacity:.3}
        .container{max-width:1200px;margin:0 auto;padding:20px;transition:transform .5s}
        .container.slide-down{transform:translateY(100%)}
        header{text-align:center;padding:30px 0;border-bottom:1px solid var(--primary-orange);margin-bottom:40px}
        .logo-container{display:flex;justify-content:center;align-items:center;margin-bottom:20px}
        .logo{height:120px;border-radius:10px;box-shadow:0 0 20px var(--primary-orange);animation:logoPop 0.8s}
        @keyframes logoPop{0%{transform:scale(0.8);opacity:0}70%{transform:scale(1.05)}100%{transform:scale(1);opacity:1}}
        .tagline{color:var(--primary-orange);font-size:1.2rem;margin-bottom:20px;text-shadow:0 0 5px rgba(var(--primary-orange-rgb),.7)}
        .terminal-prompt{background:rgba(10,10,10,.8);border:1px solid var(--primary-orange);border-radius:5px;padding:15px;margin:20px 0;box-shadow:0 0 15px rgba(var(--primary-orange-rgb),.3)}
        .prompt-line{margin:8px 0;color:var(--primary-orange)}
        .typing{overflow:hidden;white-space:nowrap;border-right:2px solid var(--primary-orange);animation:typing 3.5s steps(40),blink .75s infinite}
        @keyframes typing{from{width:0}to{width:100%}}@keyframes blink{50%{border-color:transparent}}
        section{margin:40px 0;padding:20px;background:rgba(20,20,20,.7);border-radius:5px;border:1px solid rgba(var(--primary-orange-rgb),.3)}
        h2{color:var(--primary-orange);margin:30px auto;font-size:1.8rem;text-transform:uppercase;letter-spacing:2px;text-shadow:0 0 5px rgba(var(--primary-orange-rgb),.5);position:relative;padding:15px 30px;text-align:center;background:linear-gradient(145deg,rgba(var(--primary-orange-rgb),.1),rgba(10,10,10,.3));border:1px solid var(--primary-orange);border-radius:8px;box-shadow:0 0 25px rgba(var(--primary-orange-rgb),.4),inset 0 1px 0 rgba(255,255,255,.1);max-width:400px;transition:all .3s}
        h2:hover{box-shadow:0 0 35px rgba(var(--primary-orange-rgb),.6);transform:translateY(-2px)}
        h2::before,h2::after{content:'[';color:var(--accent-orange);text-shadow:0 0 10px rgba(var(--primary-orange-rgb),.7);margin-right:10px}
        h2::after{content:']';margin-left:10px}
        .lessons-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:25px;margin-top:20px}
        .lesson-card{background:linear-gradient(145deg,#151515,#0a0a0a);border:1px solid var(--primary-orange);border-radius:8px;padding:15px;transition:all .3s;position:relative;overflow:hidden;cursor:none!important}
        .lesson-card:hover{transform:translateY(-5px);box-shadow:0 8px 20px rgba(var(--primary-orange-rgb),.4);border-color:var(--accent-orange)}
        .lesson-image{width:100%;height:160px;object-fit:cover;border-radius:5px;margin-bottom:12px;border:1px solid rgba(var(--primary-orange-rgb),.3)}
        .lesson-title{font-size:1.3rem;color:var(--light-text);margin-bottom:8px}
        .lesson-desc{color:var(--gray-text);margin-bottom:12px;font-size:.9rem;min-height:40px}
        .launch-command{color:var(--primary-orange);font-size:.9rem;font-weight:bold;padding:5px 10px;border:1px solid var(--primary-orange);border-radius:3px;transition:all .3s}
        .lesson-card:hover .launch-command{background:rgba(var(--primary-orange-rgb),.1);box-shadow:0 0 10px var(--primary-orange)}
        footer{text-align:center;padding:30px 0;margin-top:40px;border-top:1px solid var(--primary-orange);color:var(--gray-text);font-size:.9rem}
        .glow{text-shadow:0 0 5px currentColor}
        .game-page{position:fixed;top:0;left:0;width:100%;height:100%;background:var(--dark-bg);z-index:1000;display:none;transform:translateY(100%);transition:transform .5s}
        .game-page.active{transform:translateY(0);display:block}.game-page.slide-down{transform:translateY(100%)}
        .game-header{display:flex;justify-content:space-between;align-items:center;padding:15px 20px;background:rgba(20,20,20,.9);border-bottom:1px solid var(--primary-orange)}
        .game-title{color:var(--primary-orange);font-size:1.5rem;text-shadow:0 0 5px rgba(var(--primary-orange-rgb),.5)}
        .game-controls{display:flex;gap:15px}
        .btn{padding:8px 15px;background:rgba(var(--primary-orange-rgb),.2);color:var(--primary-orange);border:1px solid var(--primary-orange);border-radius:3px;cursor:none!important;transition:all .3s;font-weight:bold}
        .btn:hover{background:rgba(var(--primary-orange-rgb),.3);box-shadow:0 0 10px var(--primary-orange)}
        .game-container{height:calc(100vh - 70px);display:flex;flex-direction:column}
        .game-frame{flex:1;width:100%;border:none;background:rgba(30,30,30,.7)}
        .game-frame.fullscreen{position:fixed;top:0;left:0;width:100vw;height:100vh;z-index:9999}
        .game-frame.fullscreen ~ .game-header{display:none}
        .social-icons{position:absolute;top:20px;right:20px;display:flex;gap:15px;z-index:10}
        .search-container{max-width:600px;margin:30px auto;position:relative}
        .search-box{width:100%;padding:15px 50px 15px 20px;background:rgba(20,20,20,.8);border:2px solid var(--primary-orange);border-radius:50px;color:var(--light-text);font-size:1.1rem;outline:none;transition:all .3s;box-shadow:0 0 15px rgba(var(--primary-orange-rgb),.3);cursor:none!important}
        .search-box:focus{box-shadow:0 0 25px rgba(var(--primary-orange-rgb),.6);border-color:var(--accent-orange)}
        .search-box::placeholder{color:var(--gray-text)}.search-icon{position:absolute;right:20px;top:50%;transform:translateY(-50%);color:var(--primary-orange);font-size:1.2rem}
        .no-results{text-align:center;color:var(--gray-text);font-size:1.1rem;margin:40px 0;padding:20px;background:rgba(20,20,20,.5);border-radius:8px;border:1px solid rgba(var(--primary-orange-rgb),.3)}
        .search-stats{text-align:center;color:var(--primary-orange);margin-bottom:20px;font-size:.9rem}
        .social-icons a{color:var(--primary-orange);font-size:1.5rem;transition:all .3s;cursor:none!important}
        .social-icons a:hover{color:var(--accent-orange);transform:translateY(-2px);text-shadow:0 0 10px rgba(var(--primary-orange-rgb),.7)}
        .comments-section{max-width:1200px;margin:40px auto;padding:20px;background:rgba(20,20,20,.7);border-radius:5px;border:1px solid rgba(var(--primary-orange-rgb),.3);position:relative}
        .blur-overlay{position:absolute;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,.85);backdrop-filter:blur(12px);display:flex;flex-direction:column;justify-content:center;align-items:center;z-index:10;transition:all .5s;border-radius:5px}
        .blur-overlay.hidden{opacity:0;pointer-events:none}
        .warning-content{text-align:center;max-width:500px;padding:40px 30px;background:#1a1a1a;border-radius:12px;border:2px solid var(--primary-orange);box-shadow:0 8px 32px rgba(0,0,0,.6)}
        .warning-title{color:var(--primary-orange);margin-bottom:15px;font-size:28px;font-weight:600}
        .warning-text{margin-bottom:30px;line-height:1.5;color:var(--light-text);font-size:16px}
        .acknowledge-btn{background:var(--primary-orange);color:#000;border:none;padding:14px 35px;font-size:18px;border-radius:50px;cursor:none!important;transition:all .3s;font-weight:600}
        .acknowledge-btn:hover{background:var(--accent-orange);transform:translateY(-2px);box-shadow:0 6px 15px rgba(var(--primary-orange-rgb),.5)}
        .padlet-embed{border:1px solid rgba(0,0,0,.1);border-radius:8px;box-sizing:border-box;overflow:hidden;position:relative;width:100%;height:500px;background:0 0}
        .padlet-embed iframe{width:100%;height:100%;display:block}
        .padlet-footer{display:flex;align-items:center;justify-content:end;margin:10px 0 0;height:28px}
        .nav-tabs{display:flex;justify-content:center;margin:20px 0 30px;gap:20px}
        .nav-tab{padding:12px 30px;background:rgba(20,20,20,.8);color:var(--primary-orange);border:2px solid var(--primary-orange);border-radius:8px;cursor:none!important;font-size:1.1rem;font-weight:bold;transition:all .3s;text-transform:uppercase;letter-spacing:1px}
        .nav-tab:hover{background:rgba(var(--primary-orange-rgb),.2);box-shadow:0 0 15px var(--primary-orange);transform:translateY(-2px)}
        .nav-tab.active{background:rgba(var(--primary-orange-rgb),.3);box-shadow:0 0 20px var(--primary-orange)}
        .partners-section{display:none}.partners-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:25px;margin-top:20px}
        .partner-card{background:linear-gradient(145deg,#151515,#0a0a0a);border:1px solid var(--primary-orange);border-radius:8px;padding:20px;transition:all .3s;position:relative;overflow:hidden;cursor:none!important}
        .partner-card:hover{transform:translateY(-5px);box-shadow:0 8px 20px var(--primary-orange);border-color:var(--accent-orange)}
        .partner-image{width:100%;height:120px;object-fit:contain;border-radius:5px;margin-bottom:15px;border:1px solid rgba(var(--primary-orange-rgb),.3);background:rgba(30,30,30,.5);padding:10px}
        .partner-title{font-size:1.4rem;color:var(--light-text);margin-bottom:10px;text-align:center}
        .partner-desc{color:var(--gray-text);margin-bottom:15px;font-size:.9rem;line-height:1.5;min-height:60px}
        .partner-buttons{display:flex;justify-content:space-between;align-items:center;gap:10px}
        .discord-btn{padding:8px 12px;background:rgba(88,101,242,.2);color:#5865F2;border:1px solid #5865F2;border-radius:3px;cursor:none!important;transition:all .3s;font-size:.9rem}
        .discord-btn:hover{background:rgba(88,101,242,.3);box-shadow:0 0 10px rgba(88,101,242,.5)}
        .visit-btn{flex:1;padding:10px 15px;background:rgba(var(--primary-orange-rgb),.2);color:var(--primary-orange);border:1px solid var(--primary-orange);border-radius:3px;cursor:none!important;transition:all .3s;font-weight:bold;text-align:center}
        .visit-btn:hover{background:rgba(var(--primary-orange-rgb),.3);box-shadow:0 0 10px var(--primary-orange)}
        .theme-toggle-container{position:absolute;top:15px;left:20px;z-index:10}
        .theme-toggle-btn{background:rgba(20,20,20,.8);color:var(--primary-orange);border:1px solid var(--primary-orange);border-radius:50%;width:50px;height:50px;cursor:none!important;transition:all .3s;font-size:1.2rem;display:flex;align-items:center;justify-content:center;box-shadow:0 0 10px var(--primary-orange)}
        .theme-toggle-btn:hover{background:rgba(var(--primary-orange-rgb),.2);box-shadow:0 0 15px var(--primary-orange);transform:scale(1.1)}
        
        .theme-rainbow{
            --primary-orange:#ff0080;--primary-orange-rgb:255,0,128;--dark-bg:#0a0a0a;--light-text:#f0f0f0;
            --gray-text:#aaa;--accent-orange:#ff00ff;--cursor-bg:rgba(255,0,128,0.15);
            --cursor-border:rgba(255,0,128,0.5);--cursor-hover-bg:rgba(255,0,128,0.25);
            --cursor-hover-border:rgba(255,0,255,0.8)
        }
        .theme-rainbow .logo{filter:hue-rotate(300deg) saturate(2) brightness(1.2);box-shadow:0 0 20px #ff0080!important}
        
        .theme-cyber-green{
            --primary-orange:#00ff00;--primary-orange-rgb:0,255,0;--dark-bg:#000;--light-text:#00ff00;
            --gray-text:#008800;--accent-orange:#00cc00;--cursor-bg:rgba(0,255,0,0.15);
            --cursor-border:rgba(0,255,0,0.5);--cursor-hover-bg:rgba(0,255,0,0.25);
            --cursor-hover-border:rgba(0,204,0,0.8)
        }
        .theme-cyber-green .logo{filter:hue-rotate(100deg) saturate(3) brightness(1.1);box-shadow:0 0 20px #ff6600!important}
        
        .theme-ice-blue{
            --primary-orange:#00ccff;--primary-orange-rgb:0,204,255;--dark-bg:#001122;--light-text:#e0f7ff;
            --gray-text:#88aacc;--accent-orange:#0088cc;--cursor-bg:rgba(0,204,255,0.15);
            --cursor-border:rgba(0,204,255,0.5);--cursor-hover-bg:rgba(0,204,255,0.25);
            --cursor-hover-border:rgba(0,136,204,0.8)
        }
        .theme-ice-blue .logo{filter:hue-rotate(190deg) saturate(2) brightness(1.1);box-shadow:0 0 20px #ff3300!important}
        
        .theme-solarized{
            --primary-orange:#2aa198;--primary-orange-rgb:42,161,152;--dark-bg:#002b36;--light-text:#839496;
            --gray-text:#586e75;--accent-orange:#268bd2;--cursor-bg:rgba(42,161,152,0.15);
            --cursor-border:rgba(42,161,152,0.5);--cursor-hover-bg:rgba(42,161,152,0.25);
            --cursor-hover-border:rgba(38,139,210,0.8)
        }
        .theme-solarized .logo{filter:hue-rotate(170deg) saturate(1.8) brightness(1.1);box-shadow:0 0 20px #ff6a00!important}
        
        .theme-purple-haze{
            --primary-orange:#9b59b6;--primary-orange-rgb:155,89,182;--dark-bg:#1a1a2e;--light-text:#e2e2e2;
            --gray-text:#8884d8;--accent-orange:#6c3483;--cursor-bg:rgba(155,89,182,0.15);
            --cursor-border:rgba(155,89,182,0.5);--cursor-hover-bg:rgba(155,89,182,0.25);
            --cursor-hover-border:rgba(108,52,131,0.8)
        }
        .theme-purple-haze .logo{filter:hue-rotate(280deg) saturate(1.8) brightness(1.1);box-shadow:0 0 20px #b6596a!important}
        
        @media (max-width:768px){
            .lessons-grid,.partners-grid{grid-template-columns:1fr}
            .logo{height:80px}.game-controls{flex-direction:column;gap:10px}
            .social-icons{top:10px;right:10px}.nav-tabs{flex-direction:column;gap:10px}
            .nav-tab{padding:10px 20px}.padlet-embed{height:400px}
        }
...
.sorter-container, .sorter-box, .sorter-icon, .sorter-info {
    display: none;
}
...
@media (max-width: 768px) {
    ...
    font-family: 'Courier New', monospace;
    font-size: 0.9rem;
    box-shadow: 0 0 10px rgba(var(--primary-orange-rgb), 0.3);
    transition: all 0.3s;
}
...
.user-count {
    font-weight: bold;
    text-shadow: 0 0 5px rgba(var(--primary-orange-rgb), 0.7);
    animation: pulse 2s infinite;
}
...
.lesson-card[data-random-game="true"] .launch-command {
    color: var(--accent-orange);
    border-color: var(--accent-orange);
    box-shadow: 0 0 8px rgba(var(--primary-orange-rgb), 0.4);
}
...
<body>
    ...
    <div class="container" id="main-container">
        <header>
            <div class="user-counter" id="userCounter">
                ...
                <span>Live Users: <span class="user-count" id="liveUserCount">--</span></span>
            </div>

            <div class="social-icons">
                <a href="https://discord.gg/pCGQ8vrKza" target="_blank"><i class="fab fa-discord"></i></a>
                <a href="https://github.com/NoahsAmazingTutoringHelp" target="_blank"><i class="fab fa-github"></i></a>
                <a href="https://www.tiktok.com/@noahstutoringhub" target="_blank"><i class="fab fa-tiktok"></i></a>
            </div>
            <div class="logo-container">
                <img src="https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/logo.png" alt="Noah's Tutoring Hub" class="logo">
            </div>
            <div class="theme-toggle-container">
                <button id="themeToggle" class="theme-toggle-btn" title="Cycle Themes"><i class="fas fa-palette"></i></button>
            </div>
            <p class="tagline">ACCESSING TUTORING HUB...</p>
            <div class="terminal-prompt">
                <p class="prompt-line">> SYSTEM BOOTING...</p>
                <p class="prompt-line">> WELCOME TO NOAH'S TUTORING HUB.</p>
                <p class="prompt-line">> CONNECTING... <span class="glow" style="color: var(--primary-orange);">SUCCESS</span></p>
                <p class="prompt-line">> LESSONS LOADING...</p>
                <p class="prompt-line typing">> BOREDOM BEING SOLVED...</p>
            </div>
        </header>
        <div class="nav-tabs">
            <div class="nav-tab active" id="lessonsTab" onclick="switchTab('lessons')">LESSONS</div>
            <div class="nav-tab" id="partnersTab" onclick="switchTab('partners')">PARTNERS</div>
        </div>
        <section id="lessons-section">
            <h2>POPULAR</h2>
            <div class="lessons-grid" id="popularLessonsGrid">
            </div>
        </section>
        <section id="all-lessons">
            <h2>ALL LESSONS</h2>
            <div class="search-container">
                <input type="text" id="searchInput" class="search-box" placeholder="> SEARCH LESSONS... [TYPE TO FILTER]">
            ...
            <div class="lessons-grid" id="allLessonsGrid">
            </div>
        </section>
        <section id="partners-section" class="partners-section">
            ...
            <div class="partners-grid">
                <div class="partner-card">
                    <img src="https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/reimagined-octo-winner@main/pictures/1.jpg" alt="Partner Logo" class="partner-image">
                    <h3 class="partner-title">Bloxcraft UBG</h3>
                    <p class="partner-desc">Ultimate UBG site with hundreds of lessons right on your fingertips!</p>
                    <div class="partner-buttons">
                        <button class="discord-btn" onclick="window.open('https://discord.gg/sqPFYEsz8F', '_blank')"><i class="fab fa-discord"></i></button>
                        <button class="visit-btn" onclick="window.open('https://bloxcraft-ubg.pages.dev/', '_blank')">VISIT SITE</button>
                    </div>
                </div>
                <div class="partner-card">
                    <img src="https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/reimagined-octo-winner@main/pictures/2.jpg" alt="Partner Logo" class="partner-image">
                    <h3 class="partner-title">Glacier Arcade</h3>
                    <p class="partner-desc">Premium unblocked games with 400+ titles including Buckshot Roulette, Ultrakill, All FNAF games, and Minecraft. Smooth design, instant play.</p>
                    <div class="partner-buttons">
                        <button class="discord-btn" onclick="window.open('https://discord.gg/zfBZvZUHmR', '_blank')">
                            <i class="fab fa-discord"></i>
                        </button>
                        <button class="visit-btn" onclick="window.open('https://glacierarcade.xyz/', '_blank')">VISIT SITE</button>
                    </div>
                </div>
                <div class="partner-card">
                    <img src="https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/reimagined-octo-winner@main/pictures/3.jpg" alt="Partner Logo" class="partner-image">
                    <h3 class="partner-title">Rosin</h3>
                    <p class="partner-desc">Rosin, your one-stop for 567+ unblocked games with clean UI, accounts, and BYOD. All this and much more. Made with ❤️ for gamers everywhere.</p>
                    <div class="partner-buttons">
                        <button class="discord-btn" onclick="window.open('https://discord.gg/xzwUY9R8Tp', '_blank')">
                            <i class="fab fa-discord"></i>
                        </button>
                        <button class="visit-btn" onclick="window.open('https://afcyqmpzsb.itafricagroup.com/', '_blank')">VISIT SITE</button>
                    </div>
                </div>
                <div class="partner-card">
                    <img src="https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/reimagined-octo-winner@main/pictures/4.png" alt="Partner Logo" class="partner-image">
                    <h3 class="partner-title">GN-Math</h3>
                    <p class="partner-desc">Most popular UBG sites use my games!! (doge unblocker, frogies arcade, truffled, petezah and more)</p>
                    <div class="partner-buttons">
                        <button class="discord-btn" onclick="window.open('https://discord.gg/gn-math', '_blank')">
                            <i class="fab fa-discord"></i>
                        </button>
                        <button class="visit-btn" onclick="window.open('https://gn-math.dev/', '_blank')">VISIT SITE</button>
                    </div>
                </div>
                <div class="partner-card">
                    <img src="https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/reimagined-octo-winner@main/pictures/6.jpg" alt="Partner Logo" class="partner-image">
                    <h3 class="partner-title">Truffled</h3>
                    <p class="partner-desc">Join us so we can grow and hopefully be one of the biggest unblocked game sites ❤️</p>
                    <div class="partner-buttons">
                        <button class="discord-btn" onclick="window.open('https://discord.gg/truffled', '_blank')">
                            <i class="fab fa-discord"></i>
                        </button>
                        <button class="visit-btn" onclick="window.open('https://truffled.lol/', '_blank')">VISIT SITE</button>
                    </div>
                </div>
            </div>
        </section>
        <section class="comments-section">
            <div class="blur-overlay" id="warningOverlay">
                <div class="warning-content">
                    <h2 class="warning-title">⚠️ WARNING</h2>
                    <p class="warning-text">This comments section may contain unmoderated content.
                        <br>Proceed at your own discretion.</p>
                    <button class="acknowledge-btn" onclick="hideWarning()">I UNDERSTAND</button>
                </div>
            </div>
            <h2>COMMENTS</h2>
            <div class="padlet-embed">
                <iframe src="https://padlet.com/embed/umbm4l3umufymqfb" frameborder="0" allow="camera;microphone;geolocation"></iframe>
            </div>
        </section>
        <footer>
            <p>© 2026 Noah's Tutoring Hub. All rights reserved.</p>
    ...
    <button class="btn refresh-btn" onclick="refreshGame()" title="Refresh Game"><i class="fas fa-redo"></i> Refresh</button>
    <button class="btn" onclick="toggleFullscreen()"><i class="fas fa-expand"></i> Fullscreen</button>
    <button class="btn" onclick="downloadCurrentGame()"><i class="fas fa-download"></i> Download</button>
    <button class="btn" onclick="closeLesson()"><i class="fas fa-times"></i> Exit</button>
</div>
        </div>
        <div class="game-container">
            <iframe id="gameFrame" class="game-frame" frameborder="0" src=""></iframe>
        </div>
    </div>

    <script>
        const games = [
            { title: "A Difficult Game About Climbing", desc: "A physics-based platformer where you control a climber's hands to ascend a treacherous mountain", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/172.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/294.jpg" },
            { title: "Stick War Legacy", desc: "A popular mobile strategy game where you lead armies of stick figures, managing resources like gold to build units", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/171.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/293.jpg" },
            { title: "Buster Jam", desc: "A fast-paced, cartoon-style action-adventure game with hectic platforming and hilarious boss battles", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/170.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/292.jpg" },
            { title: "Dungeons & Degenerate Gamblers", desc: "A pixel-art roguelike deck-builder that twists traditional blackjack", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/173.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/295.jpg" },
            { title: "Minecraft 1.12.1", desc: "Minecraft 1.12 was the world of color update focused on expanding building options with vibrant colors", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/164.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/291.jpg" },
            { title: "Gorilla Tag", desc: "VR-inspired physics game where you swing and climb as gorillas through colorful environments", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/161.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/289.jpg" },
            { title: "Goblin Goopmaxxing", desc: "A dark comedy sandbox story about brewing bizarre potions and experimenting on unfortunate goblin specimens", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/160.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/288.jpg" },
            { title: "Midnight Shift", desc: "Tense horror game where you survive a night shift with supernatural occurrences and jump scares", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/159.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/287.jpg" },
            { title: "Orange Roulette", desc: "Colorful Russian roulette-style game with fruit-themed weapons and unpredictable outcomes", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/158.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/286.jpg" },
            { title: "Five Nights at Winstons", desc: "Office-themed horror game inspired by FNAF with quirky animatronics and survival mechanics", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/157.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/285.jpg" },
            { title: "Final Fantasy VII", desc: "Iconic RPG adventure with memorable characters, epic story, and turn-based combat system", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/156.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/284.jpg" },
            { title: "Please Dont Touch Anything", desc: "Interactive horror experience where you must resist touching objects with escalating consequences", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/155.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/283.jpg" },
            { title: "Minesweeper Classic", desc: "A single-player logic puzzle where you clear a grid of hidden mines by revealing tiles", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/163.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/290.jpg" },
            { title: "Doom 3", desc: "A sci-fi horror first-person shooter at a Mars research base where teleportation experiments open a gateway to Hell, unleashing demons and zombies.", url: "https://doom3kaidensarcade.netlify.app/", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/282.jpg" },
            { title: "Slendy Tubbies", desc: "A popular indie horror game series blending the cute Teletubbies with the terrifying mechanics of Slender", url: "https://rawcdn.githack.com/thirstygithub/mrmooremath/edf912ae4d86452b59348babd57f3b8c86dcbe86/public/assets/storage/webgl/st/index.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/281.jpg" },
            { title: "Pixel Gun 3D", desc: "A popular blocky pixelated first-person shooter and a campaign where players fight hordes of pixelated zombies", url: "https://rawcdn.githack.com/thirstygithub/mrmooremath/edf912ae4d86452b59348babd57f3b8c86dcbe86/public/assets/storage/webgl/pg3d/index.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/280.jpg" },
            { title: "Flying Gorilla", desc: "A free, addictive 3D mobile arcade runner where players control a flying gorilla", url: "https://rawcdn.githack.com/thirstygithub/mrmooremath/edf912ae4d86452b59348babd57f3b8c86dcbe86/public/assets/storage/webgl/fg/index.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/279.jpg" },
            { title: "Eat The Rich", desc: "An Incremental Black Friday Simulator where you gather a mob and score massive savings!", url: "https://rawcdn.githack.com/thirstygithub/mrmooremath/edf912ae4d86452b59348babd57f3b8c86dcbe86/public/assets/storage/webgl/eattherich/index.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/278.jpg" },
            { title: "Grand Thef Auto Vice City", desc: "An 80s-inspired open-world crime saga. Drive fast, build a criminal empire, and shoot your way to the top in a neon-soaked city", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/149.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/272.jpg" },
            { title: "Heretic", desc: "A dark medieval first-person shooter. Wield powerful magic and weapons to battle hordes of dark fantasy creatures.", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/150.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/273.jpg" },
            { title: "Bacon May Die", desc: "A fast-paced, 2D run and gun fighting game where you play as an angry pig warrior", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/151.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/274.jpg" },
            { title: "Oneshot", desc: "A unique narrative puzzle game. Guide a child through a strange, dying world, forming a unique bond that transcends the game itself", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/152.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/275.jpg" },
            { title: "Jelly Drift", desc: " A wobbly physics-based racer. Master the slippery momentum of your jelly car to drift and slide around colorful tracks", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/153.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/276.jpg" },
            { title: "FNF Rewrite", desc: "A deceptive Friday Night Funkin' mod featuring the EXE character Rewrite. Starts as a typical horror mod before revealing a twist, with only two intense songs", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/154.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/277.jpg" },
            { title: "Terraria", desc: "2D sandbox adventure with exploration, building, crafting, and combat in a procedurally generated world", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/165.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/271.jpg" },
            ...
            { title: "Plants Vs Zombies 2", desc: "Defend your lawn with crazy plants against fun-loving zombies across time", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/162.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/197.jpg", popular: true },
            { title: "Hotline Miami", desc: "Fast-paced top-down action combat", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/16.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/22.jpg", popular: true },
            { title: "Balatro", desc: "Build insane poker hands with special Joker cards", url: "https://raw.githack.com/thirstygithub/mathamatic-notes/main/index.html",  image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/195.jpg",popular: true },
            ...
            { title: "FNAF", desc: "Original horror survival", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/166.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/164.jpg" },
            { title: "FNAF 2", desc: "Sequel horror survival", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/167.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/165.jpg" },
            { title: "FNAF 3", desc: "Third installment horror", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/168.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/166.jpg" },
            { title: "FNAF 4", desc: "Nightmare horror survival", url: "https://raw.githack.com/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/master/games/169.html", image: "https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/images/167.jpg" },
    ...
    console.log('Opening game:', t, 'URL:', u);
}
...
function closeLesson() {
    if (typeof gtag !== 'undefined') {
        gtag('event', 'game_exit', {
            'event_category': 'game_interaction',
            'event_label': document.getElementById('gameTitle').textContent,
            'value': 1
        });
    }
...
function refreshGame() {
    ...
    setTimeout(() => {
        ...
        gameTitle.innerHTML = '<i class="fas fa-sync-alt fa-spin" style="margin-right: 8px;"></i>' + gameTitle.textContent;
        ...
        if (typeof gtag !== 'undefined') {
            gtag('event', 'game_refreshed', {
                'event_category': 'game_interaction',
                'event_label': gameTitle.textContent,
                'value': 1
            });
        }
    }, 100);
...
function toggleFullscreen() {
    ...
    if (typeof gtag !== 'undefined') {
        gtag('event', isFullscreen ? 'fullscreen_exit' : 'fullscreen_enter', {
            'event_category': 'game_interaction',
            'event_label': document.getElementById('gameTitle').textContent,
            'value': 1
        });
...
async function downloadCurrentGame() {
    ...
    console.log('Download attempted for:', url, 'Title:', title);
    
    if (url && (url.includes('https://raw.githack.com/') || url.includes('games/')) && url.includes('.html')) {
        if (typeof gtag !== 'undefined') {
...
function injectWatermark(htmlContent, gameTitle) {
   const watermarkHTML = `
    ...
    <script>
        console.log('%c🔄 Loading game downloaded from Noah\\'s Tutoring Hub', 'color: #c27c15; font-weight: bold;');
    <\/script>
...
`;
    ...
    <script>
        (function() {
            ...
            console.log('%c🎮 Game: "' + gameTitle + '", Downloaded from Noah\\'s Tutoring Hub', 
                'color: #c27c15; font-weight: bold; font-size: 14px;');
            console.log('%c📚 Visit https://noahs-calculus-tutor.pages.dev/ for more games!', 
                'color: #e69500;');
        })();
    <\/script>
`;
    ...
    if (bodyEndIndex !== -1) {
        ...
        htmlContent += watermarkHTML + protectionScript;
    }
...
function createGameCard(game, isRandom = false) {
    ...
    if (game.title.length > 20) {
        launchCommand = game.title.split(' ')
            .filter(word => word.length > 0)
            .map(word => word[0].toUpperCase())
            .join('');
    } else {
        launchCommand = game.title.toUpperCase()
            .replace(/[^A-Z0-9]/g, '_')
            .replace(/_+/g, '_')
            .replace(/^_|_$/g, '');
    }
    
    if (launchCommand.length > 15) {
        launchCommand = launchCommand.substring(0, 12) + '...';
    }
...
window.addEventListener('resize', () => {
    ...
    resizeTimeout = setTimeout(() => {
        ...
        if (columns !== drops.length) {
            const newDrops = [];
            for(let x = 0; x < columns; x++) {
                const oldX = Math.floor(x * (oldWidth / columns) / fontSize);
                if (oldX < drops.length) {
                    newDrops[x] = Math.floor(drops[oldX] * (canvas.height / oldHeight));
                } else {
            ...
            for(let x = 0; x < columns; x++) {
                drops[x] = Math.floor(drops[x] * (canvas.height / oldHeight));
            }
        }
...
function handleFullscreenChange() {
    ...
    if (!document.fullscreenElement && 
        ...
        if (gamePage) {
            ...
            gamePage.classList.remove('slide-down');
        }
    }
...
document.addEventListener('DOMContentLoaded', function() {
    const sortSelect = document.getElementById('sortSelect');
    const sorterInfo = document.getElementById('sorterInfo');
    
        function updateSorterInfo(method) {
        const infoMap = {
        ...
        sorterInfo.textContent = infoMap[method] || 'SORTING...';
    }
    ...
    sortSelect.addEventListener('change', function(e) {
        ...
        updateGameDisplay(sortedGames);
        updateSorterInfo(currentSortMethod);
    ...
    const interactive = document.querySelectorAll(
        ...
        '.visit-btn, .acknowledge-btn, .sorter-wrapper, .social-icons a'
    );
    ...
    const padletEmbed = document.querySelector('.padlet-embed');
    if (padletEmbed) {
        const padletIframe = padletEmbed.querySelector('iframe');
        if (padletIframe) {
            padletIframe.addEventListener('mouseenter', () => {
                isOverIframe = true;
                hideCustomCursor();
                document.documentElement.style.cursor = 'auto';
            });
            
            padletIframe.addEventListener('mouseleave', () => {
                isOverIframe = false;
                showCustomCursor();
                document.documentElement.style.cursor = 'none';
            });
    ...
    window.addEventListener('beforeunload', () => {
        ...
        clearTimeout(iframeCheckTimeout);
            ...
            class UserCounter {
                constructor() {
                    this.countElement = document.getElementById('liveUserCount');
                    this.baseCount = 0;
                    this.lastUpdate = 0;
                ...
                generateUserId() {
                    let userId = localStorage.getItem('tutoringhub_userId');
                    if (!userId) {
                        userId = 'user_' + Date.now() + '_' + Math.random().toString(36).substr(2, 9);
                        localStorage.setItem('tutoringhub_userId', userId);
                    }
                    return userId;
                }
                ...
                loadCount() {
                    try {
                        const activeUsers = JSON.parse(localStorage.getItem('tutoringhub_activeUsers') || '{}');
                        const now = Date.now();
                        
                        Object.keys(activeUsers).forEach(userId => {
                            if (now - activeUsers[userId] > 15 * 60 * 1000) {
                                delete activeUsers[userId];
                            }
                        });
                        
                        activeUsers[this.userId] = now;
                        localStorage.setItem('tutoringhub_activeUsers', JSON.stringify(activeUsers));
                        
const timeOfDay = new Date().getHours();
let base = 1200;


if (timeOfDay >= 8 && timeOfDay <= 15) base += 150;
else if (timeOfDay >= 16 && timeOfDay <= 22) base += 200;
else base -= 100;


base += Math.floor(Math.random() * 201) - 100;


this.baseCount = Math.max(1000, Math.min(1500, base));
                        
                    } catch (e) {
    console.error('Error loading user count:', e);
    this.baseCount = 95;
}
                }
                ...
                updateCounter() {
                    const now = Date.now();
                    if (now - this.lastUpdate < 30000) return;
                    
                    this.loadCount();
                    
                    const fluctuation = Math.floor(Math.random() * 5) - 2;
                    const displayCount = Math.max(80, this.baseCount + fluctuation);
                    
                    if (this.countElement) {
                        const currentCount = parseInt(this.countElement.textContent) || displayCount;
                        this.animateCount(currentCount, displayCount);
                    }
                    
                    this.lastUpdate = now;
                    this.trackToAnalytics(displayCount);
                }
                ...
                animateCount(start, end) {
                    ...
                    const animateStep = () => {
                        ...
                        if (step < steps) {
                            ...
                            this.countElement.textContent = end;
                        }
                    };
                ...
                setupVisibilityTracking() {
                    ...
                    if (!document.hidden) {
                        setTimeout(() => this.updateCounter(), 5000);
                    }
                }
                ...
                startCleanup() {
                    setInterval(() => {
                        try {
                            ...
                            Object.keys(activeUsers).forEach(userId => {
                                if (now - activeUsers[userId] > 30 * 60 * 1000) {
                                    delete activeUsers[userId];
                                    changed = true;
                                }
                            });
                ...
                trackToAnalytics(count) {
                    if (typeof gtag !== 'undefined') {
                        gtag('event', 'live_users_update', {
                            'event_category': 'engagement',
                            'event_label': 'user_counter',
                            'value': count
                        });
                    }
                }
...
function initializeFaviconAndTitle() {
    ...
    console.log('Initialized favicon and title');
}

document.addEventListener('visibilitychange', function() {
    if (document.hidden) {
        document.title = "Home";
        setFavicon(inactiveIcon);
    } else {
        currentSubject = getRandomSubject();
        document.title = `Noahs Tutoring | ${currentSubject}`;
        setFavicon(activeIcon);
